...
const boyMathDivLesson: Quiz = {
  id: "boy-math-div-lesson",
  mode: "boy",
  section: "math-division",
  sectionLabel: "📖 Lesson",
  title: "Division: Lesson",
  tagline: "Understand the WHY behind division",
  cover: coverBlocks,
  accent: "from-violet-400 to-purple-500",
  questions: finalize([
    {
      visual: "Dividend",
      prompt: "In 12 ÷ 4 = 3, what is the DIVIDEND?",
      options: ["12", "4", "3", "÷"],
      answer: 0,
      fact: "The dividend is the number being divided — the total you start with.",
      steps: ["Write the equation: 12 ÷ 4 = 3", "The FIRST number (12) is what we split up", "We divide THIS number", "So the dividend = 12 ✓"],
    },
    {
      visual: "Divisor",
      prompt: "In 12 ÷ 4 = 3, what is the DIVISOR?",
      options: ["4", "12", "3", "="],
      answer: 0,
      fact: "The divisor is the number you divide BY — how many equal groups you make.",
      steps: ["Write the equation: 12 ÷ 4 = 3", "The SECOND number (4) is how many groups", "We divide BY this number", "So the divisor = 4 ✓"],
    },
    {
      visual: "Quotient",
      prompt: "In 12 ÷ 4 = 3, what is the QUOTIENT?",
      options: ["3", "12", "4", "48"],
      answer: 0,
      fact: "The quotient is the result — how many are in each equal group.",
      steps: ["Write: 12 ÷ 4 = 3", "After dividing, we get the answer", "This result is called the QUOTIENT", "Quotient = 3 ✓"],
    },
    {
      visual: "Remainder",
      prompt: "In 13 ÷ 4, what is the REMAINDER?",
      options: ["1", "3", "4", "0"],
      answer: 0,
      fact: "13 ÷ 4 = 3 remainder 1. The remainder is what's left over after equal groups.",
      steps: ["13 ÷ 4 — can 4 go into 13 exactly?", "4 × 3 = 12 (closest without going over)", "13 − 12 = 1 left over", "So quotient = 3, remainder = 1 ✓"],
    },
    {
      visual: "n ÷ 1",
      prompt: "Any number divided by 1 equals…",
      options: ["The number itself", "0", "1", "Doubled"],
      answer: 0,
      fact: "e.g. 847 ÷ 1 = 847. Dividing by 1 makes 1 group of everything — nothing changes.",
      steps: ["Dividing by 1 means making 1 group", "All items go into that 1 group", "847 ÷ 1 = 847", "Works for ANY number ✓"],
    },
    {
      visual: "n ÷ n",
      prompt: "Any non-zero number divided by ITSELF equals…",
      options: ["1", "0", "2", "The number"],
      answer: 0,
      fact: "e.g. 999 ÷ 999 = 1. You always get exactly 1 group with 1 item each.",
      steps: ["Try: 12 ÷ 12", "You split 12 things into 12 groups", "Each group gets exactly 1 thing", "So 12 ÷ 12 = 1 ✓", "Works for ANY non-zero number!"],
    },
    {
      visual: "0 ÷ n",
      prompt: "Zero divided by ANY non-zero number equals…",
      options: ["0", "1", "The number", "Undefined"],
      answer: 0,
      fact: "0 ÷ 5 = 0. You have nothing to split, so each group gets nothing.",
      steps: ["You have 0 cookies to share", "Split among 5 friends", "Each friend gets 0 cookies", "0 ÷ 5 = 0 ✓"],
    },
    {
      visual: "n ÷ 0",
      prompt: "Dividing by ZERO is…",
      options: ["Undefined — not allowed", "Always 0", "Always 1", "The same number"],
      answer: 0,
      fact: "Division by zero is undefined in maths. You cannot split into 0 groups.",
      steps: ["Ask: how many groups of 0 make 12?", "No matter how many 0s you add…", "…they still equal 0, never 12", "So 12 ÷ 0 is UNDEFINED ✓"],
    },
    {
      visual: "✅ Check",
      prompt: "Best way to check if 56 ÷ 7 = 8 is correct?",
      options: ["Multiply: 8 × 7 = 56 ✓", "Divide again", "Add 7 eight times", "Subtract 7 from 56"],
      answer: 0,
      fact: "Division and multiplication are inverse operations — they undo each other.",
      steps: ["You got: 56 ÷ 7 = 8", "To verify, REVERSE the operation", "Multiply the quotient × divisor", "8 × 7 = 56", "56 = 56 ✓ Correct!"],
    },
    {
      visual: "📐 Rule",
      prompt: "Can division be done in any order? (Is it commutative?)",
      options: ["No — 12 ÷ 4 ≠ 4 ÷ 12", "Yes — same as multiplication", "Only with even numbers", "Only with whole numbers"],
      answer: 0,
      fact: "Division is NOT commutative. 12 ÷ 4 = 3, but 4 ÷ 12 = 0.333…",
      steps: ["Multiplication: 3 × 4 = 4 × 3 = 12 ✓", "Try division: 12 ÷ 4 = 3", "Swap order: 4 ÷ 12 = 0.333…", "3 ≠ 0.333…, so NOT commutative!", "Always keep the ORDER in division ✓"],
    },
    {
      visual: "Long division",
      prompt: "In 95 ÷ 5 using long division, what's the first step?",
      options: ["Divide 9 by 5 → 1 remainder 4", "Divide 95 by 5 at once", "Multiply 9 × 5 first", "Subtract 5 from 95"],
      answer: 0,
      fact: "Long division works digit by digit from left to right.",
      steps: ["Look at first digit: 9 ÷ 5 = 1 r 4", "Write 1 above the 9", "Multiply: 1 × 5 = 5, subtract: 9 − 5 = 4", "Bring down the 5 → now have 45", "45 ÷ 5 = 9", "Answer: 19 ✓"],
    },
    {
      visual: "÷ decimals",
      prompt: "48 ÷ 0.4 — what's the smart move?",
      options: ["Multiply both by 10 → 480 ÷ 4", "Ignore the decimal", "Divide 48 by 4 then add .0", "Multiply 48 × 0.4"],
      answer: 0,
      fact: "Multiply both numbers by the same power of 10 to remove the decimal from the divisor.",
      steps: ["Divisor is 0.4 — has one decimal place", "Multiply BOTH by 10:", "48 × 10 = 480, 0.4 × 10 = 4", "Now: 480 ÷ 4 = 120 ✓", "Same answer, no decimals needed!"],
    },
    {
      visual: "Factors",
      prompt: "Which pair are factor pairs of 24?",
      options: ["6 and 4", "5 and 5", "7 and 3", "8 and 5"],
      answer: 0,
      fact: "Factor pairs multiply to give the original number. 6 × 4 = 24, so both 6 and 4 divide 24 evenly.",
      steps: ["Ask: which numbers multiply to make 24?", "Try 6 × 4 = 24 ✓", "So 24 ÷ 6 = 4 and 24 ÷ 4 = 6", "6 and 4 are a factor pair of 24 ✓"],
    },
    {
      visual: "1,000 ÷ 8",
      prompt: "1,000 ÷ 8 = ?",
      options: ["125", "120", "130", "115"],
      answer: 0,
      fact: "1,000 ÷ 8 = 125. Long division: 8 into 10 = 1 r2, bring down 0 → 20 ÷ 8 = 2 r4, bring down 0 → 40 ÷ 8 = 5.",
      steps: ["8 into 10 → 1, remainder 2", "Bring down 0 → 20", "8 into 20 → 2, remainder 4", "Bring down 0 → 40", "8 into 40 → 5, remainder 0", "Answer: 125 ✓"],
    },
  ]),
};

const boyMathDivPractice: Quiz = {
  id: "boy-math-div-practice",
  mode: "boy",
  section: "math-division",
  sectionLabel: "✏️ Practice",
  title: "Division: Practice",
  tagline: "Drill remainders, long division & decimals",
  cover: coverScience,
  accent: "from-emerald-400 to-teal-500",
  questions: finalize([
    {
      visual: "72 ÷ 8", prompt: "Solve:",
      options: ["9", "8", "7", "6"], answer: 0,
      steps: ["Ask: 8 × ? = 72", "8 × 9 = 72 ✓", "Answer: 9"],
    },
    {
      visual: "96 ÷ 6", prompt: "Solve:",
      options: ["16", "14", "18", "12"], answer: 0,
      steps: ["6 into 9 → 1 r3", "Bring down 6 → 36", "36 ÷ 6 = 6", "Answer: 16 ✓"],
    },
    {
      visual: "135 ÷ 5", prompt: "Solve:",
      options: ["27", "25", "30", "23"], answer: 0,
      steps: ["5 into 13 → 2 r3", "Bring down 5 → 35", "35 ÷ 5 = 7", "Answer: 27 ✓"],
    },
    {
      visual: "256 ÷ 8", prompt: "Solve:",
      options: ["32", "28", "36", "34"], answer: 0,
      steps: ["8 into 25 → 3 r1", "Bring down 6 → 16", "16 ÷ 8 = 2", "Answer: 32 ✓"],
    },
    {
      visual: "437 ÷ 9", prompt: "Solve (with remainder):",
      options: ["48 r5", "49 r0", "47 r4", "48 r1"], answer: 0,
      steps: ["9 into 43 → 4 r7", "Bring down 7 → 77", "9 into 77 → 8 r5", "Answer: 48 remainder 5 ✓"],
    },
    {
      visual: "1,000 ÷ 25", prompt: "Solve:",
      options: ["40", "50", "35", "45"], answer: 0,
      steps: ["25 × 4 = 100", "So 25 × 40 = 1,000", "Answer: 40 ✓"],
    },
    {
      visual: "4,500 ÷ 9", prompt: "Solve:",
      options: ["500", "450", "400", "550"], answer: 0,
      steps: ["9 into 45 = 5", "Remaining: 00", "So 4,500 ÷ 9 = 500 ✓"],
    },
    {
      visual: "3.6 ÷ 4", prompt: "Solve (decimal):",
      options: ["0.9", "0.8", "0.7", "1.2"], answer: 0,
      steps: ["4 into 3.6", "Think: 36 ÷ 4 = 9", "Place decimal: 0.9", "Answer: 0.9 ✓"],
    },
    {
      visual: "7.5 ÷ 0.5", prompt: "Solve:",
      options: ["15", "1.5", "75", "0.15"], answer: 0,
      steps: ["Multiply both by 10:", "7.5 × 10 = 75, 0.5 × 10 = 5", "75 ÷ 5 = 15", "Answer: 15 ✓"],
    },
    {
      visual: "84 ÷ 7", prompt: "Solve:",
      options: ["12", "11", "13", "14"], answer: 0,
      steps: ["7 into 8 → 1 r1", "Bring down 4 → 14", "14 ÷ 7 = 2", "Answer: 12 ✓"],
    },
    {
      visual: "576 ÷ 12", prompt: "Solve:",
      options: ["48", "46", "52", "44"], answer: 0,
      steps: ["12 into 57 → 4 r9", "Bring down 6 → 96", "96 ÷ 12 = 8", "Answer: 48 ✓"],
    },
    {
      visual: "2,016 ÷ 6", prompt: "Solve:",
      options: ["336", "326", "346", "316"], answer: 0,
      steps: ["6 into 20 → 3 r2", "Bring down 1 → 21", "21 ÷ 6 → 3 r3", "Bring down 6 → 36", "36 ÷ 6 = 6", "Answer: 336 ✓"],
    },
    {
      visual: "999 ÷ 3", prompt: "Solve:",
      options: ["333", "300", "303", "330"], answer: 0,
      steps: ["3 into 9 = 3", "3 into 9 = 3", "3 into 9 = 3", "Answer: 333 ✓"],
    },
    {
      visual: "144 ÷ 12", prompt: "Solve:",
      options: ["12", "11", "14", "13"], answer: 0,
      steps: ["12 × 12 = 144", "So 144 ÷ 12 = 12", "Verify: 12 × 12 = 144 ✓"],
    },
    {
      visual: "10,000 ÷ 4", prompt: "Solve:",
      options: ["2,500", "2,000", "2,400", "3,000"], answer: 0,
      steps: ["4 into 10 → 2 r2", "Bring down 0 → 20", "20 ÷ 4 = 5", "Remaining 000: add three zeros", "Answer: 2,500 ✓"],
    },
  ]),
};

const boyMathDivQuiz: Quiz = {
  id: "boy-math-div-quiz",
  mode: "boy",
  section: "math-division",
  sectionLabel: "🏆 Quiz",
  title: "Division: Quiz",
  ...
  questions: finalize([
    {
      visual: "🍕 Sharing pizza",
      prompt: "56 slices shared equally among 8 friends. How many slices each?",
      options: ["7", "6", "8", "9"], answer: 0,
      fact: "56 ÷ 8 = 7. Each friend gets 7 slices.",
      steps: ["Total slices: 56", "Number of friends: 8", "56 ÷ 8 = ?", "8 × 7 = 56 ✓", "Each friend gets 7 slices"],
    },
    {
      visual: "📦 Packing boxes",
      prompt: "135 apples packed into boxes of 9. How many boxes?",
      options: ["15", "13", "12", "16"], answer: 0,
      fact: "135 ÷ 9 = 15 boxes.",
      steps: ["135 apples ÷ 9 per box", "9 into 13 → 1 r4", "Bring down 5 → 45", "45 ÷ 9 = 5", "Answer: 15 boxes ✓"],
    },
    {
      visual: "🚌 Bus seats",
      prompt: "312 students, each bus holds 8. How many FULL buses needed?",
      options: ["39", "38", "40", "37"], answer: 0,
      fact: "312 ÷ 8 = 39. Exactly 39 full buses.",
      steps: ["312 ÷ 8 = ?", "8 into 31 → 3 r7", "Bring down 2 → 72", "72 ÷ 8 = 9", "Answer: 39 buses ✓"],
    },
    {
      visual: "🏅 Medals",
      prompt: "100 medals split equally into 6 events. Remainder goes to the final event. How many extra?",
      options: ["4", "2", "6", "0"], answer: 0,
      fact: "100 ÷ 6 = 16 remainder 4. The final event gets 4 extra.",
      steps: ["100 ÷ 6 = ?", "6 × 16 = 96", "100 − 96 = 4 left over", "Remainder = 4 ✓"],
    },
    {
      visual: "💰 Pocket money",
      prompt: "$4.80 split equally among 6 kids. How much each?",
      options: ["$0.80", "$0.70", "$0.90", "$1.20"], answer: 0,
      fact: "480 ÷ 6 = 80 cents = $0.80.",
      steps: ["Convert: $4.80 = 480 cents", "480 ÷ 6 = 80 cents", "= $0.80 each ✓"],
    },
    {
      visual: "🏃 Running laps",
      prompt: "A runner completes 7.2 km in 6 equal laps. How long is each lap?",
      options: ["1.2 km", "1.0 km", "1.5 km", "0.9 km"], answer: 0,
      fact: "7.2 ÷ 6 = 1.2 km per lap.",
      steps: ["7.2 ÷ 6 = ?", "Think: 72 ÷ 6 = 12", "Place decimal: 1.2", "Each lap = 1.2 km ✓"],
    },
    {
      visual: "📚 Books",
      prompt: "432 books sorted onto shelves of 12. How many shelves?",
      options: ["36", "34", "38", "32"], answer: 0,
      fact: "432 ÷ 12 = 36 shelves.",
      steps: ["12 into 43 → 3 r7", "Bring down 2 → 72", "72 ÷ 12 = 6", "Answer: 36 shelves ✓"],
    },
    {
      visual: "🎮 High score",
      prompt: "A game scores 1,500 points over 4 equal rounds. Points per round?",
      options: ["375", "350", "400", "325"], answer: 0,
      fact: "1,500 ÷ 4 = 375.",
      steps: ["1,500 ÷ 4 = ?", "4 into 15 → 3 r3", "Bring down 0 → 30", "30 ÷ 4 → 7 r2", "Bring down 0 → 20", "20 ÷ 4 = 5", "Answer: 375 ✓"],
    },
    {
      visual: "🌍 Time zones",
      prompt: "360° around the Earth divided by 24 hours. Degrees per hour?",
      options: ["15°", "10°", "20°", "12°"], answer: 0,
      fact: "360 ÷ 24 = 15. Each hour the Earth rotates 15°.",
      steps: ["360 ÷ 24 = ?", "Simplify: 360 ÷ 24", "24 × 15 = 360 ✓", "Answer: 15° per hour"],
    },
    {
      visual: "🍫 Chocolate",
      prompt: "3 chocolate bars, each split into 8 pieces. 6 friends share equally. How many pieces each?",
      options: ["4", "3", "5", "6"], answer: 0,
      fact: "3 × 8 = 24 pieces. 24 ÷ 6 = 4 pieces each.",
      steps: ["Total pieces: 3 × 8 = 24", "24 ÷ 6 friends = ?", "24 ÷ 6 = 4", "Each friend gets 4 pieces ✓"],
    },
    {
      visual: "⚽ Teams",
      prompt: "93 players to form teams of 11. How many full teams, and how many left over?",
      options: ["8 teams r5", "9 teams r0", "8 teams r3", "7 teams r9"], answer: 0,
      fact: "93 ÷ 11 = 8 remainder 5. 8 full teams, 5 players left over.",
      steps: ["93 ÷ 11 = ?", "11 × 8 = 88", "93 − 88 = 5 left over", "Answer: 8 teams, remainder 5 ✓"],
    },
    {
      visual: "🚀 Fuel",
      prompt: "A rocket uses 2,400 kg of fuel over 8 equal stages. Fuel per stage?",
      options: ["300 kg", "250 kg", "350 kg", "400 kg"], answer: 0,
      fact: "2,400 ÷ 8 = 300 kg per stage.",
      steps: ["2,400 ÷ 8 = ?", "24 ÷ 8 = 3", "Add the two zeros back", "Answer: 300 kg ✓"],
    },
    {
      visual: "🧁 Bake sale",
      prompt: "576 cupcakes baked in trays of 24. How many trays?",
      options: ["24", "22", "26", "20"], answer: 0,
      fact: "576 ÷ 24 = 24 trays.",
      steps: ["576 ÷ 24 = ?", "24 into 57 → 2 r9", "Bring down 6 → 96", "96 ÷ 24 = 4", "Answer: 24 trays ✓"],
    },
    {
      visual: "🏗️ Floors",
      prompt: "A building is 252 metres tall with floors of equal height 7 m each. How many floors?",
      options: ["36", "32", "38", "34"], answer: 0,
      fact: "252 ÷ 7 = 36 floors.",
      steps: ["252 ÷ 7 = ?", "7 into 25 → 3 r4", "Bring down 2 → 42", "42 ÷ 7 = 6", "Answer: 36 floors ✓"],
    },
    {
      visual: "🎯 Challenge",
      prompt: "If 1,296 ÷ n = 36, what is n?",
      options: ["36", "32", "18", "48"], answer: 0,
      fact: "1,296 ÷ 36 = 36. So n = 36.",
      steps: ["1,296 ÷ n = 36", "Rearrange: n = 1,296 ÷ 36", "36 × 36 = 1,296 ✓", "Answer: n = 36"],
    },
  ]),
};
...
export const QUIZZES: Quiz[] = [
  ...
  boyMathDivLesson, boyMathDivPractice, boyMathDivQuiz,
];
